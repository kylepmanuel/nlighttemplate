    ...
    public class DefaultCustomerGenerator : IEnumerable<object[]>
    {
        private readonly List<object[]> _data =
            [
                ...
                [Customer.GenerateDemo(), "", "", true],
                [Customer.GenerateDemo(), "{Id}", "1", true],
                [Customer.GenerateDemo(), "{FirstName}|{LastName}", "John|Doe", true],
                [Customer.GenerateDemo(), "{FirstName}|{LastName} -{foreach Orders} Order Id: {Id}{/foreach Orders}", "John|Doe - Order Id: 123 Order Id: 124", true],
                [Customer.GenerateDemo(), "{FirstName}|{LastName} -{foreach Orders} Order Id: {Id} {foreach Details}{Quantity}{Product.Name}{/foreach Details}{/foreach Orders}", "John|Doe - Order Id: 123 1Blue Shirt2White Socks Order Id: 124 1Red Shoes4White Shirt", true],
                [Customer.GenerateDemo(),
