...
namespace NLightTemplate.Tests.Generators
{
    ...
    {
        private static readonly StringTemplateConfiguration _cfg = new FluentStringTemplateConfiguration().OpenToken("<$").CloseToken("$>").ForeachToken("fe").ExposeConfiguration();
        private readonly List<object[]> _data =
            [
                [Customer.GenerateDemo(),_cfg, "", ""],
                [Customer.GenerateDemo(),_cfg, "<$Id$>", "1"],
                [Customer.GenerateDemo(),_cfg, "<$FirstName$>|<$LastName$>", "John|Doe"],
                [Customer.GenerateDemo(),_cfg, "<$FirstName$>|<$LastName$> -<$fe Orders$> Order Id: <$Id$><$/fe Orders$>", "John|Doe - Order Id: 123 Order Id: 124"],
                [Customer.GenerateDemo(),_cfg, "<$FirstName$>|<$LastName$> -<$fe Orders$> Order Id: <$Id$> <$fe Details$><$Quantity$><$Product.Name$><$/fe Details$><$/fe Orders$>", "John|Doe - Order Id: 123 1Blue Shirt2White Socks Order Id: 124 1Red Shoes4White Shirt"],
                [Customer.GenerateDemo(),_cfg,
